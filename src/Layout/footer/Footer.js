...
import appstoreIcon from '../../Asserts/images/appstore-icon.jpg';
import googlepalyIcon from '../../Asserts/images/googlepaly-icon.jpg';
import microsoftIcon from '../../Asserts/images/microsoft-icon.jpg';
import './Footer.css';
        ...
        <div class="row">
          ...
          <div className="col-12 col-lg-auto ml-auto">
            <ul className="app-icon">
              <li><a href="#"><img src={appstoreIcon}/></a></li>
              <li><a href="#"><img src={googlepalyIcon}/></a></li>
              <li><a href="#"><img src={microsoftIcon}/></a></li>
            </ul>
          </div>
        </div>
      </div>
